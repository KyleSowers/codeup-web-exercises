...
let userFavoriteColor = prompt("Tell me your favorite color.");
...
let theLittleMermaid = prompt("For how many days have you rented out the movie: The Little Mermaid?")
theLittleMermaid = parseInt(theLittleMermaid);

console.log("Days user has had The Little Mermaid: " + theLittleMermaid);

let brotherBear = prompt("For how many days have you rented out the movie: Brother Bear?")
brotherBear = parseInt(brotherBear);

console.log("Days user has had Brother Bear: " + brotherBear);

let hercules = prompt("For how many days have you rented out the movie: Hercules?")
hercules = parseInt(hercules);

console.log("Days user has had Hercules: " + hercules);

let totalUserCost = (theLittleMermaid + brotherBear + hercules) * 3;
...
let payGoogleContract = prompt("First, how much does the Google contract pay per hour?");
payGoogleContract = parseInt(payGoogleContract);

console.log("Google pays: $" + payGoogleContract + " per hour.");

let hoursThisWeekGoogle = prompt("How many hours were worked for Google this week?");
hoursThisWeekGoogle = parseInt(hoursThisWeekGoogle);

console.log("User hours worked for Google: " + hoursThisWeekGoogle);

let payFacebookContract = prompt("Now, how much does the Facebook contract pay per hour?");
payFacebookContract = parseInt(payFacebookContract);

console.log("Facebook pays: $" + payFacebookContract + " per hour.");

let hoursThisWeekFacebook = prompt("And how many hours were worked for Facebook this week?");
hoursThisWeekFacebook = parseInt(hoursThisWeekFacebook);

console.log("User hours worked for Facebook: " + hoursThisWeekFacebook);

let payAmazonContract = prompt("Finally, how much does the Amazon contract pay per hour?");
payAmazonContract = parseInt(payAmazonContract);

console.log("Amazon pays: $" + payAmazonContract + " per hour.");

let hoursThisWeekAmazon = prompt(" And how many hours were worked for Amazon this week?");
hoursThisWeekAmazon = parseInt(hoursThisWeekAmazon);

console.log("User hours worked for Amazon: " + hoursThisWeekAmazon);

let totalContractorWeekPay = (payGoogleContract * hoursThisWeekGoogle) + (payFacebookContract * hoursThisWeekFacebook) + (payAmazonContract * hoursThisWeekAmazon);
